...
if "sel_hood" not in st.session_state:
    ...
    # Keep the selected neighbourhood alive across page changes.
    st.session_state.sel_hood = st.session_state.sel_hood


# Guard against a neighbourhood being removed by sidebar filters.
...
# Blue highlights the selected neighbourhood and grey shows the market.
fig = px.histogram(
    plot_df,
    x="price",
    color="highlight",
